...
<header>
  <nav class="navbar navbar-expand-lg spec-navbar mb-5 mr-0 pr-0">
    <a class="navbar-brand" href="index.php"><span class="logo text-dark">MusicPlay</span></a>
    ...
    <div class="collapse navbar-collapse ml-1" id="navbarColor02">
      <ul class="navbar-nav ml-auto mr-auto">
        <li class="nav-item active">
          <a class="nav-link spec-nav-link spec-nav-link-anim" dats-src="index.php" href="index.php">Главная <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link spec-nav-link spec-nav-link-anim" dats-src="audio/php/" href="#">Рекомендации</a>
        </li>
        <li class="nav-item">
          <a class="nav-link spec-nav-link spec-nav-link-anim" dats-src="audio/php/" href="#">Жанры</a>
        </li>
        <li class="nav-item">
          <a class="nav-link spec-nav-link spec-nav-link-anim" dats-src="audio/php/" href="#">Радио</a>
        </li>
      </ul>
    </div>
    ...
    <div class="collapse navbar-collapse" id="spec-nav-personal">
      ...
      if (isset($_SESSION['logged_user'])) : ?>
        <div class="spec-dropdown-menu">
          ...
          <!-- катаог: Моя музыка -->
          <span class="spec-nav-link-anim"><a href="Audio/profile.php" dats-src="Audio/profile.php" id="spec-nav-link-liked" class="nav-link">
